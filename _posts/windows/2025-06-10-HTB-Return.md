...
tags: [HackTheBox, Windows, Web Enumeration, Service Manipulation]
---
...
![img1]({{ site.baseurl }}/assets/img/return/1.jpg)

![img2]({{ site.baseurl }}/assets/img/return/2.png)
...
![img3]({{ site.baseurl }}/assets/img/return/3.png)
...
![img4]({{ site.baseurl }}/assets/img/return/4.png)

Aquí nos encontramos con un usuario llamado _svc-printer_

![img5]({{ site.baseurl }}/assets/img/return/5.png)
...
![img6]({{ site.baseurl }}/assets/img/return/6.png)
...
![img7]({{ site.baseurl }}/assets/img/return/7.png)
...
![img8]({{ site.baseurl }}/assets/img/return/8.png)

![img9]({{ site.baseurl }}/assets/img/return/9.png)
...
![img10]({{ site.baseurl }}/assets/img/return/10.png)

![img11]({{ site.baseurl }}/assets/img/return/11.png)

Y establecemos la conexión.

![img12]({{ site.baseurl }}/assets/img/return/12.png)

Navegando por los directorios encontramos la flag de usuario

![img13]({{ site.baseurl }}/assets/img/return/13.png)
...
![img14]({{ site.baseurl }}/assets/img/return/14.png)
...
![img15]({{ site.baseurl }}/assets/img/return/15.png)
...
![img16]({{ site.baseurl }}/assets/img/return/16.png)

Y lo subimos a la máquina víctima

![img17]({{ site.baseurl }}/assets/img/return/17.png)

Ahora con Metasploit configuraremos un listener para la reverse Shell que subimos en la máquina víctima.

![img18]({{ site.baseurl }}/assets/img/return/18.png)

![img19]({{ site.baseurl }}/assets/img/return/19.png)

![img20]({{ site.baseurl }}/assets/img/return/20.png)
...
![img21]({{ site.baseurl }}/assets/img/return/21.png)

![img22]({{ site.baseurl }}/assets/img/return/22.png)
...
![img23]({{ site.baseurl }}/assets/img/return/23.png)
...
![img24]({{ site.baseurl }}/assets/img/return/24.png)

Ahora solo nos queda encontrar la flag correspondiente.

![img25]({{ site.baseurl }}/assets/img/return/25.png)
