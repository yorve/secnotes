...
tags: [DockerLabs, Linux, Web, Information Leakage, PrivEsc]
---

![img1]({{ site.baseurl }}/assets/img/influencer/1.png)
...
![img1]({{ site.baseurl }}/assets/img/influencer/objetivo.png)
...
![img2]({{ site.baseurl }}/assets/img/influencer/script.png)

La primera etapa nos muestra un escaneo de puertos y servicios detectados.

![img3]({{ site.baseurl }}/assets/img/influencer/servicios.png)

La segunda etapa nos muestra información sobre el servicio web

![img4]({{ site.baseurl }}/assets/img/influencer/web.png)
...
![img8]({{ site.baseurl }}/assets/img/influencer/fuerzabruta1.png)
...
![img9]({{ site.baseurl }}/assets/img/influencer/login1.png)
...
![img10]({{ site.baseurl }}/assets/img/influencer/gobuster1.png)

En este escaneo encontramos una ruta a /login.php, aquí nos encontramos con otro panel de login.

![img11]({{ site.baseurl }}/assets/img/influencer/login2.png)
...
![img12]({{ site.baseurl }}/assets/img/influencer/login3.png)
...
![img13]({{ site.baseurl }}/assets/img/influencer/login4.png)
...
![img14]({{ site.baseurl }}/assets/img/influencer/fuerzabruta2.png)
...
![img15]({{ site.baseurl }}/assets/img/influencer/usuario.png)
...
![img16]({{ site.baseurl }}/assets/img/influencer/ssh.png)
...
![img17]({{ site.baseurl }}/assets/img/influencer/ssh1.png)

![img18]({{ site.baseurl }}/assets/img/influencer/ssh2.png)
...
![img19]({{ site.baseurl }}/assets/img/influencer/ssh3.png)
...
![img20]({{ site.baseurl }}/assets/img/influencer/ssh4.png)

y al ejecutarlo nos dará la contraseña de root

![img21]({{ site.baseurl }}/assets/img/influencer/root.png)

y podemos cambiarnos al usuario root

![img22]({{ site.baseurl }}/assets/img/influencer/root1.png)
