...
tags: [TryHackMe, Linux, Web, BruteForce, PrivEsc]
---
...
![img9]({{ site.baseurl }}/assets/img/mr_robot/9.png)
...
![img18]({{ site.baseurl }}/assets/img/mr_robot/18.png)
...
![img19]({{ site.baseurl }}/assets/img/mr_robot/19.png)

![img20]({{ site.baseurl }}/assets/img/mr_robot/20.png)
...
![img21]({{ site.baseurl }}/assets/img/mr_robot/21.png)

Al archivo **key-2-of-3.txt** no tenemos el permiso para leerlo, ya que solo usuario robot tiene los permisos para hacerlo.

![img22]({{ site.baseurl }}/assets/img/mr_robot/22.png)

El archivo password.raw-md5 nos muestra un texto cifrado

![img23]({{ site.baseurl }}/assets/img/mr_robot/23.png) 

![img24]({{ site.baseurl }}/assets/img/mr_robot/24.png)
...
![img25]({{ site.baseurl }}/assets/img/mr_robot/25.png)

![img26]({{ site.baseurl }}/assets/img/mr_robot/26.png)
...
![img27]({{ site.baseurl }}/assets/img/mr_robot/27.png)
...
(https://medium.com/@abinreji8/interactive-mode-vulnerability-in-nmap-3-81-971ddfd1b27a)
 ...
 ![img28]({{ site.baseurl }}/assets/img/mr_robot/28.png)

 ![img29]({{ site.baseurl }}/assets/img/mr_robot/29.png)
...
![img30]({{ site.baseurl }}/assets/img/mr_robot/30.png)
