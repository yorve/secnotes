...
![banner]({{ site.baseurl }}/assets/img/fruits/banner.png)
...
![img1]({{ site.baseurl }}/assets/img/fruits/reconocimiento.png)

![img2]({{ site.baseurl }}/assets/img/fruits/recon.png)
...
![img3]({{ site.baseurl }}/assets/img/fruits/web.png)

Al ingresar a la web, nos encontramos con una página y un buscador de frutas.

![img4]({{ site.baseurl }}/assets/img/fruits/buscador.png)
...
![img5]({{ site.baseurl }}/assets/img/fruits/codigo.png)
...
![img6]({{ site.baseurl }}/assets/img/fruits/gobuster.png)

Pero que al acceder a él, no tenemos nada... 

![img7]({{ site.baseurl }}/assets/img/fruits/fuzz.png)
...
![img8]({{ site.baseurl }}/assets/img/fruits/ffuf.png)
...
![img8.1]({{ site.baseurl }}/assets/img/fruits/ffuf-filtro.png)
...
![img9]({{ site.baseurl }}/assets/img/fruits/LFI.png)
...
![img10]({{ site.baseurl }}/assets/img/fruits/hydra.png)
...
![img11]({{ site.baseurl }}/assets/img/fruits/find.png)
...
![img12]({{ site.baseurl }}/assets/img/fruits/gtfobins.png)

Según **GTFObins** tenemos un método de lanzar una Shell como usuario root con el comando:

`find . -exec /bin/sh -p \; -quit`, 

![img13]({{ site.baseurl }}/assets/img/fruits/root.png)
