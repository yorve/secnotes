...
tags: [DockerLabs, Linux, Web, Fuzzing]
---
...
Comenzamos con un escaneo a los puertos de la máquina objetivo, con el fin de enumerar sus servicios dispoibles.
 ...
 ![img2]({{ site.baseurl }}/assets/img/obssesion/2.png)
...
![img3]({{ site.baseurl }}/assets/img/obssesion/3.png)
...
![img4]({{ site.baseurl }}/assets/img/obssesion/4.png)


Vemos el archivo chat-gonza.txt 

![img5]({{ site.baseurl }}/assets/img/obssesion/5.png)
 
Y el archivo pendientes.txt

![img6]({{ site.baseurl }}/assets/img/obssesion/6.png)
...
![img7]({{ site.baseurl }}/assets/img/obssesion/7.png)

![img8]({{ site.baseurl }}/assets/img/obssesion/8.png) 
...
![img9]({{ site.baseurl }}/assets/img/obssesion/9.png)

 ![img10]({{ site.baseurl }}/assets/img/obssesion/10.png)

 
En la ruta _/backup_, encontramos un archivo de texto que nos confirma que un usuario válido es russoski

![img11]({{ site.baseurl }}/assets/img/obssesion/11.png)

![img12]({{ site.baseurl }}/assets/img/obssesion/12.png) 
...
![img13]({{ site.baseurl }}/assets/img/obssesion/13.png)
...
`-t 64` - número de hilos simultáneos (64 intentos paralelos. Esto realiza el ataque más rápido, pero más ruidoso)
 ...
 ![img14]({{ site.baseurl }}/assets/img/obssesion/14.png)
...
![img18]({{ site.baseurl }}/assets/img/obssesion/18.png)
...
![img19]({{ site.baseurl }}/assets/img/obssesion/19.png) 

![img20]({{ site.baseurl }}/assets/img/obssesion/20.png)

Ejecutamos el primer comando (a) y obtenemos acceso como root

![img21]({{ site.baseurl }}/assets/img/obssesion/21.png)
 
Ahora solo navegamos por los directorios en búsqueda del famoso video.

![img22]({{ site.baseurl }}/assets/img/obssesion/22.png)


![img23]({{ site.baseurl }}/assets/img/obssesion/23.png)
