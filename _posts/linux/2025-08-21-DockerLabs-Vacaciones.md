...
![img2]({{ site.baseurl }}/assets/img/vacaciones/1.png)
...
![img3]({{ site.baseurl }}/assets/img/vacaciones/2.png)
 
Gobuster y Nmap no nos arrojó información 

![img4]({{ site.baseurl }}/assets/img/vacaciones/3.png)
 
![img5]({{ site.baseurl }}/assets/img/vacaciones/4.png) 

Ni siquiera el código de la pagina ni inspeccionando nos muestra información. 

![img6]({{ site.baseurl }}/assets/img/vacaciones/5.png)

![img7]({{ site.baseurl }}/assets/img/vacaciones/6.png)

  
Si hacemos una petición con `curl` nos mostrara el siguiente mensaje oculto.

![img8]({{ site.baseurl }}/assets/img/vacaciones/7.png)
...
![img11]({{ site.baseurl }}/assets/img/vacaciones/10.png)

Ahora tenemos las credenciales de **Juan**. Vamos a conectarnos por ssh con ellas.

![img12]({{ site.baseurl }}/assets/img/vacaciones/11.png) 
...
![img13]({{ site.baseurl }}/assets/img/vacaciones/12.png)
...
![img14]({{ site.baseurl }}/assets/img/vacaciones/13.png)
 
Y efectivamente tenemos una forma de hacerlo.

![img15]({{ site.baseurl }}/assets/img/vacaciones/14.png)

Al ejecutar el comando obtendremos una Shell como root

![img16]({{ site.baseurl }}/assets/img/vacaciones/15.png)

Con el comando `echo $SHELL` veremos que interprete de comandos usamos

![img17]({{ site.baseurl }}/assets/img/vacaciones/14.png)
 
Sabiendo que usamos bash podemos mejorar la Shell con `bash -i`

![img18]({{ site.baseurl }}/assets/img/vacaciones/17.png)
