...
tags: [HackerLabs, Linux, Enumeration, LFI, PHP-Wrappers, RCE, ROT13, Zip-Cracking, JohnTheRipper, LXC, LXD, Container-Escape]
---
![banner]({{ site.baseurl }}/assets/img/templo/banner.png)
...
![img1]({{ site.baseurl }}/assets/img/templo/reconocimiento.png)

![img2]({{ site.baseurl }}/assets/img/templo/reconocimiento_servicios.png)

![img3]({{ site.baseurl }}/assets/img/templo/reconocimiento_directorios.png)
...
![img4]({{ site.baseurl }}/assets/img/templo/web.png)
...
![img5]({{ site.baseurl }}/assets/img/templo/wow.png)

![img6]({{ site.baseurl }}/assets/img/templo/opt.png)
...
![img7]({{ site.baseurl }}/assets/img/templo/namari.png)
...
![img8]({{ site.baseurl }}/assets/img/templo/web-namari.png)

Al subir el archivo aparentemente no tenemos respuesta, pero si podemos ver algo interesante.. 

![img9]({{ site.baseurl }}/assets/img/templo/lfi.png)
...
![img10]({{ site.baseurl }}/assets/img/templo/lfi1.png)
...
![img11]({{ site.baseurl }}/assets/img/templo/phpwrapper.png)

![img12]({{ site.baseurl }}/assets/img/templo/wrapper.png)

Ya que tenemos el texto codificado en Base64, nos queda decodificarlo y ver que encontramos.

![img13]({{ site.baseurl }}/assets/img/templo/decode.png)

![img14]({{ site.baseurl }}/assets/img/templo/index.png)
...
![img15]({{ site.baseurl }}/assets/img/templo/test.png)

hacemos la conversión para saber el nombre del archivo.

![img16]({{ site.baseurl }}/assets/img/templo/rot13.png)

![img17]({{ site.baseurl }}/assets/img/templo/command.png)
...
![img18]({{ site.baseurl }}/assets/img/templo/reverseshell.png)

![img19]({{ site.baseurl }}/assets/img/templo/reverse_shell.png)
...
![img20]({{ site.baseurl }}/assets/img/templo/opt.png)
...
![img21]({{ site.baseurl }}/assets/img/templo/http.server.png)
...
![img25]({{ site.baseurl }}/assets/img/templo/rodgar.png)

Efectivamente era la contraseña de este usuario.
 
![img26]({{ site.baseurl }}/assets/img/templo/userflag.png)
...
![img30]({{ site.baseurl }}/assets/img/templo/contenedor-lxc.png)

Ahora nos falta el último paso que, en nuestro caso, es buscar la flag del usuario root

![img31]({{ site.baseurl }}/assets/img/templo/root.png)
