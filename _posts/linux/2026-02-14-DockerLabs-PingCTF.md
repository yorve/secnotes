...
tags: [DockerLabs, Linux, ICMP, Command Injection, RCE]
---
...
![img2]({{ site.baseurl }}/assets/img/ping/escaneo1.png)

Este script nos muestra la siguiente información:

![img3]({{ site.baseurl }}/assets/img/ping/escaneo2.png)

Al acceder al servicio web desde el navegador, nos encontramos con una herramienta de Ping

![img4]({{ site.baseurl }}/assets/img/ping/web.png)

![img5]({{ site.baseurl }}/assets/img/ping/web1.png)
...
![img6]({{ site.baseurl }}/assets/img/ping/rce.png)
...
El primer paso será elegir un interprete disponible en el sistema. Así que, con el comando `which` buscaremos una shell disponible (bash, sh, python, python3, perl, nc)
 ...
 ![img7]({{ site.baseurl }}/assets/img/ping/shell.png)
...
Para ejecutar nuestra reverse shell, pegaremos el código después del separador que utilizamos en el momento de confirmar el RCE
 ...
 ![img8]({{ site.baseurl }}/assets/img/ping/rshell.png)
 
 
 ![img9]({{ site.baseurl }}/assets/img/ping/rshell1.png)
 ...
 ![img10]({{ site.baseurl }}/assets/img/ping/perm.png)
...
Luego de esta búsqueda, vemos que vim tiene permisos especiales (s) lo que significa que cualquier usuario que puede lanzar vim como usuario root 
  ...
  ![img11]({{ site.baseurl }}/assets/img/ping/vim.png)
  
  ![img12]({{ site.baseurl }}/assets/img/ping/vim1.png)
...
![img13]({{ site.baseurl }}/assets/img/ping/root.png)
