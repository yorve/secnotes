...
tags: [CyberAcademy, Networking, PrivEsc]
---
...
![img1]({{ site.baseurl }}/assets/img/deloitte2/3.png)
...
![img2]({{ site.baseurl }}/assets/img/deloitte2/4.png)
...
![img3]({{ site.baseurl }}/assets/img/deloitte2/5.png)
...
![img4]({{ site.baseurl }}/assets/img/deloitte2/6.png)

el resultado nos muestra una ruta interesante **/robots.txt** y **/uploads/**

![img5]({{ site.baseurl }}/assets/img/deloitte2/7.png)
...
![img6]({{ site.baseurl }}/assets/img/deloitte2/8.png)

Al ingresar por el navegador nos encontramos en la página principal 3 enlaces.

![img7]({{ site.baseurl }}/assets/img/deloitte2/9.png)
...
![img8]({{ site.baseurl }}/assets/img/deloitte2/10.png)
...
![img9]({{ site.baseurl }}/assets/img/deloitte2/11.png)
...
Nos encontramos con una función que toma el valor ingresado por el usuario en el login y lo compara con los valores establecidos de la función. Si estos datos son incorrectos mostrará una alerta de que el usuario o contraseña son incorrectos
 ...
 ![img10]({{ site.baseurl }}/assets/img/deloitte2/12.png)
...
![img11]({{ site.baseurl }}/assets/img/deloitte2/13.png)
...
![img12]({{ site.baseurl }}/assets/img/deloitte2/14.png)
...
![img13]({{ site.baseurl }}/assets/img/deloitte2/15.png)

Al enviar la solicitud obtenemos la quinta flag. 

![img14]({{ site.baseurl }}/assets/img/deloitte2/16 .png)
...
![img19]({{ site.baseurl }}/assets/img/deloitte2/21.png)

Al navegar al directorio /home/deloitte, nos encontramos la séptima bandera. 

![img20]({{ site.baseurl }}/assets/img/deloitte2/22.png).
...
![img21]({{ site.baseurl }}/assets/img/deloitte2/23.png)
...
![img25]({{ site.baseurl }}/assets/img/deloitte2/26.png)
...
![img26]({{ site.baseurl }}/assets/img/deloitte2/27.png)

Confirmando que existe, nos crearemos una Reverse Shell para conectarnos al servidor.

![img27]({{ site.baseurl }}/assets/img/deloitte2/28.png)
...
![img28]({{ site.baseurl }}/assets/img/deloitte2/29.png)

![img29]({{ site.baseurl }}/assets/img/deloitte2/30.png)

![img30]({{ site.baseurl }}/assets/img/deloitte2/31.png)
...
![img31]({{ site.baseurl }}/assets/img/deloitte2/37.png)

![img31]({{ site.baseurl }}/assets/img/deloitte2/38.png)

![img32]({{ site.baseurl }}/assets/img/deloitte2/39.png)
...
![img33]({{ site.baseurl }}/assets/img/deloitte2/10flag.png)
