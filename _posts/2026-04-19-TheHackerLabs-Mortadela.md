...
tags: [Hackerlabs, Writeup, Linux, SQLi, WPScan, JohnTheRipper, KeePass, Memory Forensics, CVE-2023-32784, PrivEsc]
---
...
![img1]({{ site.baseurl }}/assets/img/mortadela/reconocimiento.png)

![img2]({{ site.baseurl }}/assets/img/mortadela/reconocimiento2.png)

![img3]({{ site.baseurl }}/assets/img/mortadela/reconocimiento3.png)

Adicionalmente vamos a hacer un escaneo de directorios web

![img4]({{ site.baseurl }}/assets/img/mortadela/gobuster.png)
...
![img5]({{ site.baseurl }}/assets/img/mortadela/wpscan .png)

![img6]({{ site.baseurl }}/assets/img/mortadela/wp-user.png)
...
![img14]({{ site.baseurl }}/assets/img/mortadela/user-flag.png)
...
![img15]({{ site.baseurl }}/assets/img/mortadela/unzip.png)
...
![img16]({{ site.baseurl }}/assets/img/mortadela/wget.png)
...
![img19]({{ site.baseurl }}/assets/img/mortadela/keepass.png)

![img20]({{ site.baseurl }}/assets/img/mortadela/keepass1.png)
...
![img21]({{ site.baseurl }}/assets/img/mortadela/keepassdumper.png)

![img22]({{ site.baseurl }}/assets/img/mortadela/keepassdumper1.png)

![img23]({{ site.baseurl }}/assets/img/mortadela/bd.png)
...
![img24]({{ site.baseurl }}/assets/img/mortadela/bd.png)

En la base de datos, tenemos unas credenciales de un usuario root 

![img25]({{ site.baseurl }}/assets/img/mortadela/root.png)

con esto solo nos queda probar estas credenciales en el servicio ssh

![img26]({{ site.baseurl }}/assets/img/mortadela/acceso-root.png)
