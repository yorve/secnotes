...
![img2]({{ site.baseurl }}/assets/img/grillo/1.png)

![img3]({{ site.baseurl }}/assets/img/grillo/2.png)

![img4]({{ site.baseurl }}/assets/img/grillo/3.png)

**Enumeración**

![img5]({{ site.baseurl }}/assets/img/grillo/4.png)
 

Al escanear el objetivo nos encontramos con alguna información necesaria para enumerar directorios.

![img6]({{ site.baseurl }}/assets/img/grillo/5.png)
...
![img7]({{ site.baseurl }}/assets/img/grillo/6.png)
...
![img10]({{ site.baseurl }}/assets/img/grillo/9.png)

![img11]({{ site.baseurl }}/assets/img/grillo/10.png)
...
![img12]({{ site.baseurl }}/assets/img/grillo/11.png)
