...
tags: [DockerLabs, Linux, LFI, SUDI, SSH, Python, Enumeration, Path-Traversal, Web-Security, PrivEsc]
---
...
![img1]({{ site.baseurl }}/assets/img/patriaquerida/inicio.png)

![img2]({{ site.baseurl }}/assets/img/patriaquerida/inicio1.png)
...
![img3]({{ site.baseurl }}/assets/img/patriaquerida/web1.png)
...
![img4]({{ site.baseurl }}/assets/img/patriaquerida/web2.png)
...
![img5]({{ site.baseurl }}/assets/img/patriaquerida/nikto.png)
...
![img6]({{ site.baseurl }}/assets/img/patriaquerida/nikto2.png)
...
![img7]({{ site.baseurl }}/assets/img/patriaquerida/web3.png)

El siguiente paso será comprobar si **balu** es una contraseña.

![img8]({{ site.baseurl }}/assets/img/patriaquerida/ssh.png)
...
![img9]({{ site.baseurl }}/assets/img/patriaquerida/ssh.png)
...
![img10]({{ site.baseurl }}/assets/img/patriaquerida/mario.png)

repetimos procedimientos y tenemos la misma info..

![img11]({{ site.baseurl }}/assets/img/patriaquerida/mario1.png)
...
![img12]({{ site.baseurl }}/assets/img/patriaquerida/root.png)
