...
tags: [Command Injection, RCE, Sudo, Abuse Of Functionality, APT, AWS-CLI, Netcat, stty, Linux, GTFObins, Shell Escape]
---
...
![img1]({{ site.baseurl }}/assets/img/zapas/recon.png)

![img2]({{ site.baseurl }}/assets/img/zapas/recon2.png)
...
![img3]({{ site.baseurl }}/assets/img/zapas/zapas.png)
...
![img4]({{ site.baseurl }}/assets/img/zapas/directorios.png)
...
![img9]({{ site.baseurl }}/assets/img/zapas/commandinjection.png)
...
![img12]({{ site.baseurl }}/assets/img/zapas/nota.png)
...
![img13]({{ site.baseurl }}/assets/img/zapas/http-server.png)
...
![img14]({{ site.baseurl }}/assets/img/zapas/crackzip.png)

![img15]({{ site.baseurl }}/assets/img/zapas/jhon-the-ripper.png)

Ya tenemos la contraseña del archivo , procedemos a descomprimir y ver que nos encontramos.

![img15]({{ site.baseurl }}/assets/img/zapas/unzip.png)

Contraseña del usuario **pronike** obtenida...

![img16]({{ site.baseurl }}/assets/img/zapas/pronike.png)
...
![img19]({{ site.baseurl }}/assets/img/zapas/aproadidas.png)
...
![img20]({{ site.baseurl }}/assets/img/zapas/aws.png)

Aquí el procedimiento es igual al usuario anterior. aprovecharemos el paginador para realizar la escala de privilegios

![img22]({{ site.baseurl }}/assets/img/zapas/escalada1.png)

![img23]({{ site.baseurl }}/assets/img/zapas/escalada2.png)

y al ejecutar `!/bin/bash` ganamos acceso como el usuario root.

![img24]({{ site.baseurl }}/assets/img/zapas/root.png)

![img25]({{ site.baseurl }}/assets/img/zapas/flags.png)

_archivo sudoers_

![img26]({{ site.baseurl }}/assets/img/zapas/sudoers.png)
